          ...
          <div className="greeting-text-div">
            <div>
              ...
              <h1 className="greeting-sub" style={{ color: theme.grayText }}>
                We're <mark data-entity="team">{greeting.sub}</mark>
              </h1>
              ...
              <span
                ...
                <div className="entities">
                  A<mark data-entity="noun">Full Stack Developer</mark>{" "}
                  who thrives to{" "}
                  <mark data-entity="verb">leverage Startups</mark> using
                  AI-based solutions along with{" "}
                  <mark data-entity="skill">Blockchain Development</mark> and a blend
